...
#define jsondict_type 1121
#define jsondict_double_starred_kvpairs_type 1122
#define jsondict_double_starred_kvpair_type 1123
#define Ejsondict_kvname_type 1124
...
#define del_target_end_type 1141
...
#define invalid_del_target_type 1158
...
#define _loop0_30_type 1189
#define _loop1_31_type 1190
#define _loop0_33_type 1191
#define _gather_32_type 1192
#define _tmp_34_type 1193
...
#define _tmp_68_type 1227
#define _loop0_70_type 1228
#define _gather_69_type 1229
...
#define _loop0_126_type 1284
#define _gather_125_type 1285
...
static expr_ty jsondict_rule(Parser *p);
static asdl_seq* jsondict_double_starred_kvpairs_rule(Parser *p);
static KeyValuePair* jsondict_double_starred_kvpair_rule(Parser *p);
static KeyValuePair* Ejsondict_kvname_rule(Parser *p);
...
atom_rule(Parser *p)
{
    ...
    { // &'${' (jsondict)
        ...
        D(fprintf(stderr, "%*c> atom[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "&'${' (jsondict)"));
        expr_ty jsondict_var;
        if (
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 54)  // token='${'
            &&
            (jsondict_var = jsondict_rule(p))  // jsondict
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'${' (jsondict)"));
            _res = jsondict_var;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s atom[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "&'${' (jsondict)"));
    }
    { // '...'
        if (p->error_indicator) {
            D(p->level--);
...
// jsondict: '${' jsondict_double_starred_kvpairs? '}'
static expr_ty
jsondict_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    int _start_col_offset = p->tokens[_mark]->col_offset;
    UNUSED(_start_col_offset); // Only used by EXTRA macro
    { // '${' jsondict_double_starred_kvpairs? '}'
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> jsondict[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "'${' jsondict_double_starred_kvpairs? '}'"));
        Token * _literal;
        Token * _literal_1;
        void *a;
        if (
            ...
            &&
            (a = jsondict_double_starred_kvpairs_rule(p), 1)  // jsondict_double_starred_kvpairs?
            &&
            (_literal_1 = _PyPegen_expect_token(p, 26))  // token='}'
        )
        {
            D(fprintf(stderr, "%*c+ jsondict[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'${' jsondict_double_starred_kvpairs? '}'"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
            if (_token == NULL) {
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s jsondict[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "'${' jsondict_double_starred_kvpairs? '}'"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// jsondict_double_starred_kvpairs: ','.jsondict_double_starred_kvpair+ ','?
static asdl_seq*
jsondict_double_starred_kvpairs_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    asdl_seq* _res = NULL;
    int _mark = p->mark;
    { // ','.jsondict_double_starred_kvpair+ ','?
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> jsondict_double_starred_kvpairs[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "','.jsondict_double_starred_kvpair+ ','?"));
        void *_opt_var;
        UNUSED(_opt_var); // Silence compiler warnings
        asdl_seq * a;
        if (
            (a = _gather_107_rule(p))  // ','.jsondict_double_starred_kvpair+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
            D(fprintf(stderr, "%*c+ jsondict_double_starred_kvpairs[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "','.jsondict_double_starred_kvpair+ ','?"));
            _res = a;
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s jsondict_double_starred_kvpairs[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "','.jsondict_double_starred_kvpair+ ','?"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// jsondict_double_starred_kvpair: '**' bitwise_or | NAME ':' expression | NAME
static KeyValuePair*
jsondict_double_starred_kvpair_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    { // '**' bitwise_or
        ...
        D(fprintf(stderr, "%*c> jsondict_double_starred_kvpair[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "'**' bitwise_or"));
        Token * _literal;
        expr_ty a;
        if (
            (_literal = _PyPegen_expect_token(p, 35))  // token='**'
        ...
        {
            D(fprintf(stderr, "%*c+ jsondict_double_starred_kvpair[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'**' bitwise_or"));
            _res = _PyPegen_key_value_pair ( p , NULL , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s jsondict_double_starred_kvpair[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "'**' bitwise_or"));
    }
    { // NAME ':' expression
        if (p->error_indicator) {
        ...
        {
            D(fprintf(stderr, "%*c+ jsondict_double_starred_kvpair[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "NAME ':' expression"));
            _res = _PyPegen_jsondict_key_value_pair ( p , a , b );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
    ...
    { // NAME
        ...
        {
            D(fprintf(stderr, "%*c+ jsondict_double_starred_kvpair[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "NAME"));
            _res = _PyPegen_jsondict_key_value_name ( p , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
// Ejsondict_kvname: NAME
static KeyValuePair*
Ejsondict_kvname_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    { // NAME
        ...
        D(fprintf(stderr, "%*c> Ejsondict_kvname[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "NAME"));
        expr_ty a;
        if (
            (a = _PyPegen_name_token(p))  // NAME
        )
        {
            D(fprintf(stderr, "%*c+ Ejsondict_kvname[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "NAME"));
            _res = _PyPegen_jsondict_key_value_name ( p , a );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s Ejsondict_kvname[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "NAME"));
    }
    _res = NULL;
  done:
...
// _loop0_108: ',' jsondict_double_starred_kvpair
static asdl_seq *
_loop0_108_rule(Parser *p)
{
    ...
    { // ',' jsondict_double_starred_kvpair
        ...
        while (
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (elem = jsondict_double_starred_kvpair_rule(p))  // jsondict_double_starred_kvpair
        )
        {
            _res = elem;
            if (_res == NULL && PyErr_Occurred()) {
...
// _gather_107: jsondict_double_starred_kvpair _loop0_108
static asdl_seq *
_gather_107_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // jsondict_double_starred_kvpair _loop0_108
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_107[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "jsondict_double_starred_kvpair _loop0_108"));
        KeyValuePair* elem;
        asdl_seq * seq;
        if (
            (elem = jsondict_double_starred_kvpair_rule(p))  // jsondict_double_starred_kvpair
        ...
        D(fprintf(stderr, "%*c%s _gather_107[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "jsondict_double_starred_kvpair _loop0_108"));
    }
    _res = NULL;
  done:
    D(p->level--);
